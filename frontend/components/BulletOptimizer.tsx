    ...
    <div className="panel kinetic-border p-6 md:p-8 max-w-4xl mx-auto my-12 bg-slate-900/70 backdrop-blur-xl">
      ...
      {result && (
        <div className="mt-8 pt-6 border-t border-slate-700/60 space-y-6 animate-rise-fade">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="premium-card p-4 flex items-center justify-between">
              <div>
                ...
                <div className="text-3xl font-black text-slate-950 mt-1">{result.action_verb_score} / 100</div>
              </div>
            ...
            <div className="premium-card p-4 flex items-center justify-between">
              <div>
                ...
                <div className="text-lg font-black text-slate-950 mt-2">
          ...
          <div className="panel bg-neutral-950 text-white p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 rounded-xl shadow-[0_22px_70px_rgba(15,23,42,0.22)]">
            <div>
              <div className="text-xs font-bold uppercase tracking-wider text-blue-300">Ready to transform your career?</div>
